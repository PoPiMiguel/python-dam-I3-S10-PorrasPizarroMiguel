...
# Pregunta al usuario cómo ingresar texto: directamente o por archivo, con 3 intentos
...
# Función que sirve de interfaz para obtener el texto, imprimiendo título
...
# ----------------------
# Carga un modelo spaCy para español; si no disponible, crea pipeline básico
...
# Inicializa recursos nltk necesarios, descargando si faltan
...
# Inicializa clasificador de sentimiento con transformers, si disponible
...
# Menú principal
# ----------------------
# Interfaz principal que muestra menú, solicita texto y llama funciones según opción
def menu_principal():
